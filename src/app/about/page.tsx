...
function About() {
  return (
    <FullScreenMain>
        ...
        <div dir='rtl' className='w-[86vw] tracking-tighter text-justify text-[12px] leading-6 lg:text-[18px] md:w-[70vw] lg:w-[68vw] me-[7vw] md:me-[15vw] lg:me-[18vw] mt-8 lg:mt-[10vh]'>
