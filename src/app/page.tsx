...
export default function Home() {
  return (
    ...
    <div className={myFont.className}>
        <div className="text-[128px] text-center px-8 leading-[128px] py-8 pb-12 bg-stone-950 rounded-xl">
          <div className='text-[200px] w-[60%] mx-auto rounded-xl leading-[100px]  bg-gradient-to-r from-purple-600 via-fuchsia-500 to-pink-400 pt-6  '>
          ≈
          </div>
