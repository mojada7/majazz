...
function SearchItemeInput() {
  return (
    <div className='w-full px-1 rounded-xl border-[2px] dark:bg-stone-950 border-gray-300 flex items-center md:py-1'>
        ...
        <input dir='rtl' className='w-full px-2 rounded-xl dark:bg-stone-950 border-none outline-none py-1 placeholder:text-[11px]' placeholder='بگرد دنبال چیزی که میخوای ...'/>
